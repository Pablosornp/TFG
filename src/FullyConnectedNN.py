...
history = model.fit(x_train, y_train, batch_size=100, validation_split=0.2 ,epochs=number_epochs, shuffle=False, verbose=2) #entrenar la red #validar
...
axs[0].plot(epochs,history.history['loss'],history.history['val_loss'])
axs[0].set_ylabel('loss')
axs[0].set_xlabel('epoch')
axs[0].legend(['train', 'validation'], loc='upper left')
axs[1].plot(epochs[10:],history.history['loss'][10:],history.history['val_loss'][10:])
